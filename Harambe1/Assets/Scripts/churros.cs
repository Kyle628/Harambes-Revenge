...
public class churros : MonoBehaviour {
	...
	public void Spawnchurros()
	{
		...
		morechurros = (GameObject)Instantiate(Resources.Load("Churro"), new Vector3(Player.transform.position.x + Random.Range( 100.0f, 150.0f ), -5.47f, 0f), Quaternion.identity);
